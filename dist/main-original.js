...
// PLANETS //
var planetName = ["Mercury", "Venus"];
var planetYear = [230.96, 440.7];
var planetAttack = [0.2, 0.05];
var planetRelease = [2.6, 1.9];
var planetFlash = [0, 0];
var planets = [];
...
var scaleMinor = [3, 0];
var scaleArabic = [4, 0];
var scaleArabic2 = [4, 0];
var scaleGuXian = [3, 0];
var scaleAkebono = [3, 0];
var scales = [
	scaleArabic,
	scaleAkebono,
	scaleMajor,
...
function init() {
	...
	if (ua.browser.family == "Firefox" || ua.browser.family == "MSIE") {
		window.location = "http://whitevinyldesign.com/solarbeat/2010";
	}
...
function randBG() {
	var col = darkCols[Math.floor(Math.random() * darkCols.length)];
	colourTo(bgCols[1], col.r, col.g, col.b, 1, 6000);
}
